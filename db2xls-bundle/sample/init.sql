...
INSERT INTO countries(iso, iso3, iso_numeric, fips, country, capital, area_sq_km, population, continent, tld, currency_code, currency_name, phone, postal_code_format, postal_code_regex, languages, geoname_id, neighbours)
VALUES
...
('AX','ALA','248',null,'Aland Islands','Mariehamn',1580,26711,'EU','.ax','EUR','Euro','+358-18','#####','^(?:FI)*(\d{5})$','sv-AX',661882,'FI'),
...
('CN','CHN','156','CH','China','Beijing',9596960,1392730000,'AS','.cn','CNY','Yuan Renminbi','86','######','^(\d{6})$','zh-CN,yue,wuu,dta,ug,za',1814991,'LA,BT,TJ,KZ,MN,AF,NP,MM,KG,PK,KP,RU,VN,IN'),
...
('ER','ERI','232','ER','Eritrea','Asmara',121320,0,'AF','.er','ERN','Nakfa','291','','','aa-ER,ar,tig,kun,ti-ER',338010,'ET,SD,DJ'),
...
('GQ','GNQ','226','EK','Equatorial Guinea','Malabo',28051,1308974,'AF','.gq','XAF','Franc','240','','','es-GQ,fr',2309096,'GA,CM'),
...
('PE','PER','604','PE','Peru','Lima',1285220,31989256,'SA','.pe','PEN','Sol','51','','','es-PE,qu,ay',3932488,'EC,CL,BO,BR,CO'),
...
('PH','PHL','608','RP','Philippines','Manila',300000,106651922,'AS','.ph','PHP','Peso','63','####','^(\d{4})$','tl,en-PH,fil,ceb,tgl,ilo,hil,war,pam,bik,bcl,pag,mrw,tsg,mdh,cbk,krj,sgd,msb,akl,ibg,yka,mta,abx',1694008,''),
...
('RU','RUS','643','RS','Russia','Moscow',17100000,144478050,'EU','.ru','RUB','Ruble','7','######','^(\d{6})$','ru,tt,xal,cau,ady,kv,ce,tyv,cv,udm,tut,mns,bua,myv,mdf,chm,ba,inh,tut,kbd,krc,av,sah,nog',2017370,'GE,CN,BY,UA,KZ,LV,PL,EE,LT,FI,MN,NO,AZ,KP'),
